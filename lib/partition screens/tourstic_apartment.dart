...
class ApartmentAdd extends StatefulWidget {
  ApartmentAdd({Key? key}) : super(key: key);

  @override
  State<ApartmentAdd> createState() => _ApartmentAddState();
}

class _ApartmentAddState extends State<ApartmentAdd> {
  ...
  handleSumbition() async {
    try {
      ...
      if (_formKey.currentState!.validate() ||
        ...
        await apratments.doc(postId).set(
          {
            "id": postId,
